...
resource "aws_instance" "bastion" {
  ...
  user_data                   = <<-EOF
    ...
    curl -LO https://github.com/replicatedhq/kots/releases/download/v1.27.1/kots_linux_amd64.tar.gz && tar xzf kots_linux_amd64.tar.gz && sudo mv ./kots /usr/bin/kubectl-kots
