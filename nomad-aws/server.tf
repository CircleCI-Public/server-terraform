module "server" {
  ...
  tls_cert                      = var.enable_mtls ? "" : module.tls[0].nomad_server_cert
  tls_key                       = var.enable_mtls ? "" : module.tls[0].nomad_server_key
  tls_ca                        = var.enable_mtls ? "" : module.tls[0].nomad_tls_ca
