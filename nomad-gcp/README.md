...
| <a name="input_enable_firewall_logging"></a> [enable\_firewall\_logging](#input\_enable\_firewall\_logging) | If true, terraform will enable firewall logging for nomad server | `bool` | `false` | no |
